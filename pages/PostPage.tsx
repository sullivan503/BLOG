                            ...
                            <div className="flex mr-3">
                                {[...Array(5)].map((_, i) => (
                                    <Star 
                                        key={i} 
                                        size={20} 
                                        fill={i < Math.floor(post.rating || 0) ? "#fbbf24" : "none"} 
                                        className={i < Math.floor(post.rating || 0) ? "text-yellow-400" : "text-gray-200"}
                                    />
                                ))}
                            </div>
                            <span className="font-bold text-primary font-mono text-2xl">{post.rating}</span>
