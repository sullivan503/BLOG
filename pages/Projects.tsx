        ...
        <div className="max-w-4xl mx-auto space-y-20 relative">
            ...
            {isContactOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-primary/60 backdrop-blur-sm animate-fade-in">
                    <div className="bg-white w-full max-w-lg shadow-2xl overflow-hidden relative max-h-[90vh] overflow-y-auto">
                        {/* Close Button */}
                        <button
                            onClick={() => { setIsContactOpen(false); setFormStatus('idle'); }}
                            className="absolute top-4 right-4 p-2 text-gray-400 hover:text-primary transition-colors bg-gray-50 z-10"
                        >
                            <X size={20} />
                        </button>
                        ...
                        <div className="p-8 md:p-10">
                            {formStatus === 'success' ? (
                                <div className="text-center py-10 animate-fade-in">
                                    <div className="w-16 h-16 bg-green-100 text-green-600 flex items-center justify-center mx-auto mb-6">
                                        <CheckCircle size={32} />
                                    </div>
                                    ...
                                    <button
                                        onClick={() => { setIsContactOpen(false); setFormStatus('idle'); }}
                                        className="bg-gray-100 text-primary px-6 py-3 font-bold hover:bg-gray-200 transition-colors"
                                    >
                                        关闭窗口
                                    </button>
                                </div>
                                    ...
                                    <form onSubmit={handleFormSubmit} className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="text"
                                                required
                                                className="w-full bg-surface border border-gray-200 px-4 py-3 text-primary focus:outline-none focus:border-accent transition-colors"
                                                placeholder="怎么称呼您？"
                                                value={formData.name}
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                rows={3}
                                                required
                                                className="w-full bg-surface border border-gray-200 px-4 py-3 text-primary focus:outline-none focus:border-accent transition-colors resize-none"
                                        ...
                                        <button
                                            ...
                                            className="w-full bg-primary text-white font-bold py-3.5 hover:bg-black transition-colors flex items-center justify-center disabled:opacity-70 mt-2"
                                        >
            ...
            <section>
                ...
                {isLoading ? (
                        ...
                        {projects.filter(p => p.categories && (p.categories.some(c => c.toLowerCase() === 'business') || p.categories.some(c => c === '商业与运营'))).map((post) => (
                            ...
                            >
                                ...
                                <div className="flex items-center space-x-3 text-xs mb-3">
                                    ...
                                    <span className="bg-surface border border-gray-200 px-2 py-0.5 text-secondary font-bold">INSIGHT</span>
                                </div>
                    ...
                    <div className="p-6 border border-dashed border-gray-200 text-center text-sm text-secondary">
            ...
            <section>
                <div className="flex items-center justify-between mb-8">
                    ...
                    <span className="text-xs font-mono text-secondary bg-gray-100 px-2 py-1">
                        Latest 6
                    </span>
                </div>
                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {projects.filter(p => p.categories && (p.categories.some(c => c.toLowerCase() === 'projects') || p.categories.some(c => c.includes('项目')))).map((proj) => (
                            <div key={proj.id} className="bg-white p-8 border border-gray-100 hover:border-accent/30 hover:shadow-lg transition-all flex flex-col h-full group">
                    ...
                    <div className="p-8 border border-dashed border-gray-200 text-center text-secondary">
                ...
                {isLoading ? (
                    ...
                    <div className="space-y-4">
                        {achievements.map((ach) => (
                            <div key={ach.id} className="bg-surface border-l-4 border-accent pl-6 py-4 hover:bg-gray-100 transition-colors">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="border-l-4 border-accent bg-surface pl-6 py-4">
            ...
            <section className="bg-primary text-white p-8 md:p-12 relative overflow-hidden shadow-2xl">
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <button
                        ...
                        className="bg-accent hover:bg-white hover:text-accent text-white px-8 py-4 font-bold transition-all shadow-lg flex items-center whitespace-nowrap transform hover:scale-105"
                    >
                        {CTA_BUTTON_TEXT}
            ...
            {/* Resume Link */}
            <section className="bg-surface border border-gray-200 p-8 flex flex-col md:flex-row items-center justify-between gap-4">
                <div>
                ...
                <button
                    ...
                    className="flex items-center bg-white border border-gray-200 text-primary px-6 py-3 font-bold hover:border-accent hover:text-accent transition-colors whitespace-nowrap"
                >
