  ...
  return (
    <div className="relative flex flex-col items-center justify-center py-24 px-4 text-center min-h-[60vh] overflow-hidden">
      ...
      <div className="relative z-10 animate-fade-in flex flex-col items-center">
        <div className="bg-surface p-6 rounded-full mb-8 shadow-sm">
          {type === 'post' ? (
        ...
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
          <button 
            onClick={() => onNavigate('')}
            className="flex items-center justify-center bg-primary text-white px-8 py-3.5 rounded-xl font-bold hover:bg-black transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
          >
          ...
          <button 
            ...
            className="flex items-center justify-center bg-white border border-gray-200 text-primary px-8 py-3.5 rounded-xl font-bold hover:border-accent hover:text-accent transition-all shadow-sm hover:shadow-md"
          >
